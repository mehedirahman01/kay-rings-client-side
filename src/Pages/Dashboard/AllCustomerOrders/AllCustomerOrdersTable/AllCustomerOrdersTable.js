...
const AllCustomerOrdersTable = (props) => {
    ...
    return (
        <tr>
            ...
            <td><button onClick={() => props.approveOrder(singleOrder._id)} className="btn btn-success">Approve</button></td>
            <td><button onClick={() => props.handleCancelOrder(singleOrder._id)} className="btn btn-danger">Cancel</button></td>
        </tr>
    );
};

export default AllCustomerOrdersTable;